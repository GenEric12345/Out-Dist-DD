...
@hydra.main(version_base=None, config_path="configs", config_name="config_multi")
def main(cfg):
    ngpus = cfg.ngpus
    if "load_dir" in cfg:
    ...
    try:
        ...
        mp.spawn(run_train_OOD.run_multiprocess, args=(ngpus, cfg, port), nprocs=ngpus, join=True)
