...
from OOD_data_harness import noise_determine
...
def _run(rank, world_size, cfg):
    ...
    train_step_fn = losses.get_step_fn_OOD(noise, graph, True, optimize_fn, cfg.training.accum)
    ...
    while state['step'] < num_train_steps + 1:
        ...
        noise_min = noise_determine(batch, device, noise, graph)
        loss = train_step_fn(state, tokens, noise_min)
